...
public class EmployeeStatusEnumTypeHandler extends BaseTypeHandler<EmployeeStatusEnum> {
    ...
    public EmployeeStatusEnum getNullableResult(ResultSet rs, String columnName) throws SQLException {
        ...
        return value != null ? EmployeeStatusEnum.fromValue(value) : null; // 从数据库读取字符串转换为枚举
    }
